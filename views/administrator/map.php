                ...
                <div class="map__deliverymen">
                    <ul class="map__deliverymen-list">
                        <?php foreach ($repartidores as $repartidor) : ?>
                            <li class="map__deliveryman" data-delivery="<?php echo $repartidor->id_compra ?? 'null' ?>" data-id="<?= $repartidor->id ?>" <?php if ($repartidor->ubicacion) : echo "data-lat=". $repartidor->ubicacion->latitud; endif ?> <?php if ($repartidor->ubicacion) : echo "data-lng=". $repartidor->ubicacion->longitud; endif ?>>
