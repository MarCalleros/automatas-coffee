...
<nav class="navbar">
    ...
    <?php if (isLogged()): ?>
            <div id="user-logged-icons" class="navbar__user-icons">
                <a href="/carrito" class="navbar__icon-link">
...
function actualizarContadorCarrito() {
    ...
    fetch("/api/carrito/obtener")
        ...
        if (data.status === "success") {
          //Suma del total de items en el carrito
    ...
    if (typeof url === "string" && 
        (url.includes("/api/carrito/agregar") || 
        url.includes("/api/carrito/eliminar") || 
        url.includes("/api/carrito/actualizar") ||
        url.includes("/api/carrito/comprar"))) {
