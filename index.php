...
<body>
    <header class="header">
        ...
        <div class="background__text">
            <h1 class="background__title">Automatas Coffee</h1>
            <p class="background__description">El mejor café de Mochis York</p>
        </div>
        ...
        <nav class="navbar">
            <div class="navbar__header">
                ...
                <svg class="user-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier"> 
                        <path d="M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> 
                        <path d="M12 14C8.13401 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> 
                    </g>
                </svg>
            </div>
    ...
    <div>
        ...
        <div class="carousel">
            <img class="carousel__prev-icon" src="/assets/img/arrow-prev.png" alt="Anterior">
            ...
            <div class="card card--active">
                ...
                <div class="card__information">
                    ...
                    <p class="card__description">Café helado con un toque de vainilla y caramelo</p>
                </div>
            ...
            <div class="card card--active">
                ...
                <div class="card__information">
                    ...
                    <p class="card__price">$70.00</p>
                    <p class="card__description">Café espresso con leche vaporizada y una capa de espuma cremosa</p>
                </div>
            ...
            <img class="carousel__next-icon" src="/assets/img/arrow-next.png" alt="Siguiente">
        </div>
    </div>
    ...
    <div class="categories">
        <div class="category category--cafe-caliente">
            <div class="category__image">
                <img src="/assets/img/category/cafe-caliente.png" alt="Categoria Frapuccinos">
            </div>
        ...
        <div class="category category--cafe-frio">
            <div class="category__image">
                <img src="/assets/img/category/cafe-frio.png" alt="Categoria Frapuccinos">
            </div>
